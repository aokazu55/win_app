class User < ActiveRecord::Base
  ...
  has_many :bought_services, foreign_key: "buyer_id", class_name: "Service"
  has_many :selling_services, -> { where("buyer_id is NULL") }, foreign_key: "seller_id", class_name: "Service"
  has_many :sold_services, -> { where("buyer_id is not NULL") }, foreign_key: "seller_id", class_name: "Service"
